...
ActiveRecord::Schema[8.0].define(version: 20_251_015_211_343) do
  ...
  create_table 'contract_ledger_entries', force: :cascade do |t|
    ...
    t.index %w[contract_id entry_date], name: 'index_contract_ledger_entries_on_contract_id_and_entry_date'
  ...
  create_table 'contracts', force: :cascade do |t|
    ...
    t.index %w[status active], name: 'index_contracts_on_status_and_active'
  ...
  create_table 'payments', force: :cascade do |t|
    ...
    t.index %w[status due_date], name: 'index_payments_on_status_and_due_date'
