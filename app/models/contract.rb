...
class Contract < ApplicationRecord
  ...
  belongs_to :applicant_user, class_name: 'User', optional: true
  has_many_attached :documents
  has_many :payments, dependent: :destroy  # Relación con los pagos
  before_create :set_amounts

  validates :payment_term, :financing_type, :down_payment, :reserve_amount, presence: true
  ...
  def create_direct_payments
    ...
    Payment.create!(contract: self, due_date: Date.today, amount: reserve_amount, status: 'pending')
